...
export class BodyComponent implements OnInit, OnDestroy {
  ...
  LocationList()
  {
    ...
    onLocationChange() {
      this.echallan_service.getCameraList(this.locationId)
      .subscribe({
        next: (value: any) => {
          console.log(value)
  ...
  Search() {
    ...
    this.isLoading = true;
    this.echallan_service.getServerSideVehiclePassingData(this.startDate, this.endDate, this.locationId, this.PassingTypeId,1,10,"",this.cameraId)
      .subscribe({
        next: (value: any) => {
